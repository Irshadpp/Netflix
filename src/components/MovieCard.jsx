...
import { API_OPTIONS, createImageUrl } from '../util/movieServices';
...
function MovieCard({movie}) {
  ...
  return (
    <div className='transform transition-transform duration-500 hover:scale-105  relative w-[360px] sm:w-[200px] md:w-[240px] lg:w-[300px] inline-block rounded-[4px] overflow-hidden cursor-pointer m-2'>
